...
y_predict_train=model2.predict(new_x_train)
y_predict_test=model2.predict(new_x_test)
...
y_predict_train=model.predict(new_x_train)
y_predict_test=model.predict(new_x_test)
